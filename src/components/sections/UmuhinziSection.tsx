        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-green-100">
              <div className="aspect-square bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-6 flex flex-col items-center justify-center text-white">
            ...
            <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-emerald-200 rounded-full opacity-40"></div>
          </motion.div>
        </div>
      </div>
    </section>
